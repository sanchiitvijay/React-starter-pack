...
const SecretRecipe = () => {
  useEffect(() => {
    ...
    return () => {
        showHintButton.removeEventListener('click', () => {
            hintContainer.style.display = 'block';
        });

        closeHintButton.removeEventListener('click', () => {
            hintContainer.style.display = 'none';
        });
...
Put r into mixing bowl.
Put T into mixing bowl.
Pour contents of the mixing bowl into the baking dish.</strong></p>
                </div>
            </div>
            <div class="buttons">
                <button id="show-hint">Show Hint</button>
                <button id="go-back" style="display: none;">Return</button>
            </div>
            <div class="hint-container" id="hint-container">
                <div class="overlay-content">
                    <span class="close-btn" id="close-hint">&times;</span>
                    <h2>Hints</h2>
                    <div class="hints">
                        <p><i class="fas fa-lightbulb"></i> Hint 1: Look at the numbers and think about their relationship to the ASCII table.</p>
                        <p><i class="fas fa-lightbulb"></i> Hint 2: Decode the numbers to reveal letters and symbols.</p>
                        <p><i class="fas fa-lightbulb"></i> Hint 3: Pay attention to the order of the ingredients.</p>
                        <p><i class="fas fa-lightbulb"></i> Hint 4: Combine the decoded characters to find the secret message.</p>
                    </div>
        ...
        <div class="timer-popup" id="timer-popup">
            <span class="close-btn" id="close-timer-popup">&times;</span>
            <h2>Timer</h2>
            <p>The countdown timer will appear here.</p>
        </div>
        <script>
         document.querySelector('.show-hint').addEventListener('click', function() {
